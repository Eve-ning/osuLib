...
public:
	...
	SpriteCommand(int startTime, int endTime, EASING easing) : m_startTime(startTime), m_endTime(endTime), m_easing(easing) {}
...
namespace Command {
	...
	public:
		...
		Fade(int startTime, int endTime, double startF, double endF, EASING easing = EASING::Linear) :
			SpriteCommand(startTime, endTime, easing), m_startF(startF), m_endF(endF) {}
	...
	public:
		...
		Move(int startTime, int endTime, double startX, double startY, double endX, double endY, EASING easing = EASING::Linear) :
			SpriteCommand(startTime, endTime, easing), m_startX(startX), m_startY(startY), m_endX(endX), m_endY(endY) {}
	...
	public:
		...
		Scale(int startTime, int endTime, double startSX, double startSY, double endSX, double endSY, EASING easing = EASING::Linear) :
			SpriteCommand(startTime, endTime, easing), m_startSX(startSX), m_startSY(startSY), m_endSX(endSX), m_endSY(endSY) {}

		// Constructor mimics Normal Scaling (Fixed ratio)
		Scale(int startTime, int endTime, double startS, double endS, EASING easing = EASING::Linear) :
			SpriteCommand(startTime, endTime, easing), m_startSX(startS), m_startSY(startS), m_endSX(endS), m_endSY(endS) {}
	...
	public:
		...
		Rotate(int startTime, int endTime, double startR, double endR, EASING easing = EASING::Linear) :
			SpriteCommand(startTime, endTime, easing), m_startR(startR), m_endR(endR) {}
	...
	public:
		...
		Color(int startTime, int endTime, double startCR, double startCG, double startCB, double endCR, double endCG, double endCB, EASING easing = EASING::Linear) :
			SpriteCommand(startTime, endTime, easing), m_startCR(startCR), m_startCG(startCG), m_startCB(startCB), m_endCR(endCR), m_endCG(endCG), m_endCB(endCB) {}

		// Constructor for linear RGB Sequence
		Color(int startTime, int endTime, double startC, double endC, EASING easing = EASING::Linear) :
			SpriteCommand(startTime, endTime, easing), m_startCR(startC), m_startCG(startC), m_startCB(startC), m_endCR(endC), m_endCG(endC), m_endCB(endC) {}
